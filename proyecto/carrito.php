...
//print '<pre>';
//print_r($_SESSION['carrito']); //muestra  
//die;
    ...
    <div class="container" id="main">
            <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                      ...
                      ?>
                      <tr>
                          <td colspan="7">NO HAY PRODCUTOS EN EL CARRITO</td>
                      </tr>
                      <?php
                          }
                      ?>
                ...
                <div class="row">
                        ...
                        <div class="pull-right">
                          <a href="pagar.php" class="btn btn-success"> Finalizar compra</a>
                        </div>
                </div>
                <?php
                    }
