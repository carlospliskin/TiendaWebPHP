  ...
  <body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../dashboard.php">Macar Store</a>
        </div>
    ...
    <div class="container" id="main">
        <div class="row">
            <div class="col-md-12">
                <fieldset>
                <legend>Datos del articulos</legend>
                    ...
                    <div class="row">
                            <div class="col-md-4">
                                ...
                                <select class="form-control" name="categoria_id" required>
                                    ...
                                    ?>
                                      <option value="<?php print $item['id']  ?>"> <?php print $item['nombre1']  ?></option>
                                    <?php
                                     }
                                    ?>
